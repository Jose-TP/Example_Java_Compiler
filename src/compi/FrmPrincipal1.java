...
public class FrmPrincipal1 extends javax.swing.JFrame {
    ...
    private void analizarLexico() throws IOException{
        ...
        while (true) {
            ...
            switch (token) {
                    case ERROR:
                        resultado += lexer.yytext() + ": Es un " + token + "\n";
                        break;

                    case IDENTIFICADOR: case LITERAL_NUM_ENTERO: case LITERAL_NUM_FLOTANTE:case LITERAL_CARACTER: case LITERAL_STRING: case PALABRA_RESERVADA: case COMENTARIO:
                        resultado += lexer.yytext() + ": Es un " + token + "\n";
                        break;
...
private void mostrarTablaSimbolos(TablaSimbolos tabla) {
    String[] columnas = {"ID", "Nombre", "Tipo", "Tipo Dato", "Ámbito", "Valor"};
    
    List<Simbolo> simbolos = tabla.getSimbolos();
    Object[][] datos = new Object[simbolos.size()][6];
...
private void btnAnalizarActionPerformed(java.awt.event.ActionEvent evt) {
    try {
        ...
        Sintax sintax = new Sintax(lexer);  // Cambiar Parser por Sintax
        
        sintax.parse();
        
        mostrarTablaSimbolos(sintax.tabla);  // Acceder a la tabla
        ...
        try {
            ...
            List<String> erroresSemanticos = s.semantico.getErrores();
                        ...
                        if (!erroresSemanticos.isEmpty()) {
                            ...
                            sb.append("Errores semánticos encontrados:\n");
                            for (String error : erroresSemanticos) {
                                sb.append(error).append("\n");
                            }
                            txtAnalizarSin1.setText(sb.toString());
                        } else {
                            txtAnalizarSin1.setText("Análisis semántico completado sin errores.");
                        }            System.out.println("JAA334343AA");
            ...
            Symbol sym = s.getS();
            txtAnalizarSin.setText("Error "+ s.getS() +"de sintaxis. Linea: " + (sym.right + 1) + " Columna: " + (sym.left + 1) + ", Texto: \"" + sym.value + "\"");
